...
#        ty = tdx['Value']*energy_frac/1.0e6
    ...
    ax.text(xmax - (xmax-xmin)*0.45, ymax - (ymax-ymin)*0.07, 'CO2 (Energy-related)', color=config.COL_ASBESTOS_DARK, fontsize=24)

    #ax.legend(loc='lower left')
    plt.tight_layout()
    #plt.show()
    plt.savefig('charts/20260226_06_plot_co2_energy_total_EN.png')
