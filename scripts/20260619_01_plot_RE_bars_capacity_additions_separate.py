...
OUTPUT_PLOT = 'charts/20260619_01_plot_RE_bars_capacity_additions_separate.png'
...
def plot_sub(ax, df1, label, ymax, pos, title):
    ...
    for i in range(ndata1-1):
        ...
        x = year2 - year0
        value1 = df1.iloc[i][label+'_GW_IRENA']
        value2 = df1.iloc[i+1][label+'_GW_IRENA']
        diff = value2 - value1
