...
#        ax.set_ylim(ymin, ymax)
        ...
        ty = df1_sub[year1_list].iloc[0]/3600 # TJ to TWh
        ...
        if sector_str[i] != "":
            for j in range(6):
                tdx = df_sep[(df_sep['Scenario']==j) & (df_sep['Sector']==sector_str[i]) & (df_sep['Type']=='Electricity Demand')]
                tx = tdx['Year']
    ...
    plt.tight_layout()
    #plt.show()
    plt.savefig('charts/20260226_21_plot_energy_elec_subcat_TWh.png')
