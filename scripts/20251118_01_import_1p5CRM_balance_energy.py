...
list_colnames = ['energy_base', 'energy_2030', 'energy_2040', 'energy_2050']
nyears = len(list_years)
# output file names
jsonfile_data  = 'outputs/20251118_01_1p5CRM_balance_energy/20251118_01_1p5CRM_balance_energy_data.json'
excelfile_data = 'outputs/20251118_01_1p5CRM_balance_energy/20251118_01_1p5CRM_balance_energy_data.xlsx'
...
df17 = pd.DataFrame(columns = list_years)
list_df = [
...
RM_balance_excel = 'inputs/1p5CRM/20231114_1p5CRM_balance_energy_co2_rev1.xlsx'
