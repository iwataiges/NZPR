...
list_json_file = 'outputs/20251118_04_1p5CRM_steps_co2/list_20251118_04_1p5CRM_steps_co2_json.txt'
...
excelfile_data = 'outputs/20251201_04_1p5CRM_steps_co2/20251201_14_1p5CRM_steps_co2_data_common.xlsx'
...
with pd.ExcelWriter(excelfile_data) as writer:
    for jsonfile in list_json:
        ...
        if '_エネルギー利用.' in jsonfile:
            ...
            jsonfile_total = jsonfile_total.replace('20251118_04', '20251201_04').replace('co2/20251201_04', 'co2/20251201_14').replace('_co2_data','_co2_data_common')

        df2x.sort_values(by='id', inplace=True, ignore_index=True)

        outputfilename = jsonfile.replace('20251118_04', '20251201_04').replace('co2/20251201_04', 'co2/20251201_14').replace('_co2_data','_co2_data_common')
