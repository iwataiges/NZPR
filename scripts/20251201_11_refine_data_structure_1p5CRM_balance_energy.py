...
list_json_file = 'outputs/20251118_01_1p5CRM_balance_energy/list_20251118_01_1p5CRM_balance_energy_json.txt'
...
excelfile_data = 'outputs/20251201_01_1p5CRM_balance_energy/20251201_11_1p5CRM_balance_energy_data_common.xlsx'
...
with pd.ExcelWriter(excelfile_data) as writer:
    for jsonfile in list_json:
        ...
        if '_エネルギー利用.' in jsonfile:
            ...
            jsonfile_total = jsonfile_total.replace('20251118_01', '20251201_01').replace('energy/20251201_01', 'energy/20251201_11').replace('_energy_data','_energy_data_common')

        df2x.sort_values(by='id', inplace=True, ignore_index=True)

        outputfilename = jsonfile.replace('20251118_01', '20251201_01').replace('energy/20251201_01', 'energy/20251201_11').replace('_energy_data','_energy_data_common')
