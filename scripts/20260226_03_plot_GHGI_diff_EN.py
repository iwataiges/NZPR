...
#    ax.set_ylim(ymin, ymax)
    ...
    ax.text(2033, avg1-4.5, 'Required for NDC 2035: \n%3.1f MtCO2e/Yr' % (avg1), color=config.COL_ALIZARIN_DARK, fontsize=fs1, va='center', ha='center')
    ## arrow
...
#    ax.plot(tx, ty, '--', color=config.COL_NEPHRITIS_MED, linewidth=lw2)
    ...
    ax.text(2032.5, avg2-4.5, 'Required for 1.5CRM 2035: \n%3.1f MtCO2e/Yr' % (avg2), color=config.COL_NEPHRITIS_DARK, fontsize=fs1, va='center', ha='center')
    ## arrow
    arrow_style = ArrowStyle('<|-|>', head_length=0.1,head_width=0.1, widthA=lw1, widthB=lw1)
