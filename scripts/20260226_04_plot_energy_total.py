...
def plot(df1, df2, df3, year1_list, year2_list, df_sep):
    ...
    print('a:%.3e b:%.3e 2030:%.2f 2035:%.2f ' % (a, b, ty_2030, ty_2035))
    ...
    ax.text(xmax - (xmax-xmin)*0.42, ymax - (ymax-ymin)*0.07, 'FEC (エネルギー起源)', color=config.COL_ASBESTOS_DARK, fontsize=24)

    #ax.legend(loc='lower left')
    plt.tight_layout()
    #plt.show()
    plt.savefig('charts/20260226_04_plot_energy_total.png')
