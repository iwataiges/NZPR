...
INPUT_SEP_EXCEL_FILE = 'inputs/SEP/20251218_01_SEP_numbers.xlsx'
...
if __name__ == '__main__':
    ...
    df_out.to_excel('outputs/20251218_02_SEP/20251218_15_SEP_numbers.xlsx', index=False)
    df_out.to_json('outputs/20251218_02_SEP/20251218_15_SEP_numbers.json', orient='index', force_ascii=False, indent=4)
