...
#    '02_01_01', # エネルギー転換部門 (電気・熱配分後) (エネルギー起源)
    '02_01_01_01_04', # エネルギー転換部門 (電気・熱配分後)  事業用発電
]
...
# output file names
output_co2_json_file   = 'outputs/20251201_21_energy_stat/20260316_32_energy_stat_co2_data_common_0_電力_RD.json'
output_co2_excel_file  = 'outputs/20251201_21_energy_stat/20260316_32_energy_stat_co2_data_common_0_電力_RD.xlsx'
output_intensity_json_file  = 'outputs/20251218_01_intensity/20260316_32_energy_stat_intensity_data_common_0_電力_RD.json'
output_intensity_excel_file = 'outputs/20251218_01_intensity/20260316_32_energy_stat_intensity_data_common_0_電力_RD.xlsx'
...
def load_ES_data():
    ...
    input_ES_co2_elec_json_file = 'outputs/20251201_21_energy_stat/20251201_22_energy_stat_co2_data_common_0_電力.json'
    input_ES_energy_elec_json_file = 'outputs/20251201_21_energy_stat/20251201_21_energy_stat_data_common_0_電力.json'
    ...
    df4 = pd.read_json(input_ES_co2_elec_json_file, orient='index', dtype=dict_dtype)
    df5 = pd.read_json(input_ES_energy_elec_json_file, orient='index', dtype=dict_dtype)
...
def redistribute_co2(df_GHGI_et, df_ES_elec, df_ES_heat, df_ES_co2):
    ...
    for item in data_structure_common:
        ...
        for y in range(YEAR1_START, YEAR1_END):
            ...
            frac_elec = energy_es_elec_sector / energy_es_elec_total
    ...
    with pd.ExcelWriter(output_co2_excel_file) as writer:
        df_ES_co2_rev.to_excel(writer, sheet_name='電力_エネ転換再配分')
...
def calc_intensity(df_ES_co2_rev, df_ES_energy):
    ...
    with pd.ExcelWriter(output_intensity_excel_file) as writer:
        df_intensity_rev.to_excel(writer, sheet_name='電力_エネ転換再配分')
