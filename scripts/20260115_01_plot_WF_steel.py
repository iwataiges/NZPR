...
INPUT_EXCEL = 'inputs/WF/20260115鉄鋼業2035_for_WF.xlsx'
OUTPUT_PLOT1 = 'charts/20260115_01_WF_鉄鋼業2035_energy.png'
OUTPUT_PLOT2 = 'charts/20260115_01_WF_鉄鋼業2035_co2.png'
...
def plot(df, outputfilename):
    ...
    fig, ax = plt.subplots(figsize=(ndata,10))
