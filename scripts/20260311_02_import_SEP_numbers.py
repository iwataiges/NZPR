...
if __name__ == '__main__':
    ...
    df_out.to_excel('outputs/20251218_02_SEP/20260311_02_SEP_numbers.xlsx', index=False)
    df_out.to_json('outputs/20251218_02_SEP/20260311_02_SEP_numbers.json', orient='index', force_ascii=False, indent=4)
