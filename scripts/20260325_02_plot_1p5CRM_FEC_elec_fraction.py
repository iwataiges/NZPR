...
jsonfile1 = 'outputs/20251201_03_1p5CRM_steps_energy/20251201_13_1p5CRM_steps_energy_data_common_07_電力.json'
jsonfile2 = 'outputs/20251201_03_1p5CRM_steps_energy/20251201_13_1p5CRM_steps_energy_data_common_10_エネルギー利用.json'
jsonfile3 = 'outputs/20251201_01_1p5CRM_balance_energy/20251201_11_1p5CRM_balance_energy_data_common_07_電力.json'
jsonfile4 = 'outputs/20251201_01_1p5CRM_balance_energy/20251201_11_1p5CRM_balance_energy_data_common_10_エネルギー利用.json'
OUTPUT_PLOT = 'charts/20260325_02_plot_1p5CRM_FEC_elec_fraction2040.png'
...
def load_data():
    ...
    df3 = pd.read_json(jsonfile3, orient='index', dtype=dict1_dtype)
    df4 = pd.read_json(jsonfile4, orient='index', dtype=dict1_dtype)
...
def plot(df1, df2, df3, df4):
    ...
    for id in list_ids_plot:
        ...
        e_elec_steps2040 = df1_sel['2040'].values[0]

        df2_sel = df2[df2['id']==list_ids[id]]
        e_FEC_steps2040 = df2_sel['2040'].values[0]
        frac_elec_steps2040 = e_elec_steps2040 / e_FEC_steps2040

        df3_sel = df3[df3['id']==list_ids[id]]
        e_elec_balance2040 = df3_sel['2040'].values[0]

        df4_sel = df4[df4['id']==list_ids[id]]
        e_FEC_balance2040 = df4_sel['2040'].values[0]
        ...
        ax.text(tx, 1.02, '政府目標', fontsize=fs2, ha='center', va='bottom', color=config.COL_ORANGE_MED)
        ax.text(tx+xstep2, 1.02, '1.5CRM', fontsize=fs2, ha='center', va='bottom', color=config.COL_TURQUOISE_MED)
